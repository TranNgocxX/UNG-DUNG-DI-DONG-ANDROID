    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => showDialog(
          ...
          builder: (_) => RoomForm(
            onSubmit: (room) async {
              await roomDataSource.addRoom(RoomModel(
                id: '',
      ...
      body: Padding(
        ...
        child: StreamBuilder<List<RoomModel>>(
          ...
          builder: (context, snapshot) {
            ...
            final emptyRooms =
                rooms.where((r) => r.tinhTrang == 'Trống').length;
            final bookedRooms =
                rooms.where((r) => r.tinhTrang == 'Đã đặt').length;
            ...
            return Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatCard('Tổng số phòng', '$total', Icons.hotel, Colors.blue),
                    _buildStatCard('Phòng trống', '$emptyRooms', Icons.meeting_room, Colors.green),
                    _buildStatCard('Đã đặt', '$bookedRooms', Icons.event_busy, Colors.orange),
                  ],
                ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Phòng ${r.soPhong} - ${r.loaiPhong}',
                                    ...
                                    onPressed: () => showDialog(
                                      ...
                                      builder: (_) => RoomForm(
                                        ...
                                        onSubmit: (updatedRoom) async {
                                          await roomDataSource.updateRoom(RoomModel(
                                            id: r.id,
